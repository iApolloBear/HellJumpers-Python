# Generated by Django 3.0.3 on 2020-05-05 00:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promo_wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_promo_wallets', to='crud.UserWallet')),
            ],
        ),
        migrations.CreateModel(
            name='Concurso',
            fields=[
                ...
                ('contest_wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_contest_wallets', to='crud.UserWallet')),
            ],
        ),
    ]
